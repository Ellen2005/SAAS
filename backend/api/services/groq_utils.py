...
Supported current models (June 2026):
  llama-3.3-70b-versatile   — best quality (restored as primary)
  llama-3.1-8b-instant      — fast, lower latency (fallback)
  mixtral-8x7b-32768        — good for long context (fallback)
