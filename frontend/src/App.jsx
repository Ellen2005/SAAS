...
function AppShell() {
  ...
  // Show a minimal splash only while Supabase resolves the local session cache.
  // This is near-instant (<50ms) since it reads from localStorage, not the network.
  if (loading) {
    return (
            ...
            <div className="app-container">
              <nav className="navbar">
                ...
                <div className="nav-links" style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <button onClick={handleLogout} className="btn btn-outline" style={{ padding: '8px 12px', marginLeft: '24px', fontSize: '0.8rem', display: 'flex', gap: '6px' }}>
